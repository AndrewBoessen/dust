defmodule Dust.Ui.CoreComponents do
  ...
  Icons are rendered via the `hero-*` mask utilities generated by the
  Tailwind plugin in `assets/tailwind.config.js`. Use the base name for the
  outline set, or a `-solid` / `-mini` / `-micro` suffix.

      <.icon name="hero-folder" />
      <.icon name="hero-photo" class="size-5 text-zinc-500" />
  """
